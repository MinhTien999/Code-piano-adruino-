...
void 
{
  Serial.begin(9600) // tốc độ giao tiếp với máy tính, mở port ở mức 9600
  Serial.print("count = ")
  Serial.println(count) // suât dữ liệu ra cổng Serial dưới dạng chuỗi con người có thể đọc được. hàm này có thể được sử dụng dưới nhiều dạng khác nhau 
